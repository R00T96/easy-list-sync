...
-- Re-create policies to ensure idempotency
drop policy if exists "Public can read shopping items" on public.shopping_items;
create policy "Public can read shopping items"
  on public.shopping_items for select
  using (true);

drop policy if exists "Public can insert shopping items" on public.shopping_items;
create policy "Public can insert shopping items"
  on public.shopping_items for insert
  with check (true);

drop policy if exists "Public can update shopping items" on public.shopping_items;
create policy "Public can update shopping items"
  on public.shopping_items for update
  using (true)
  with check (true);

drop policy if exists "Public can delete shopping items" on public.shopping_items;
